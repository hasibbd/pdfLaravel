                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body  mx-5">
                                <form action="{{url('store-two')}}" method="post">
                                    @csrf
                                    <div class="row">
                                            ...
                                            <table class="custom-table">
                                                ...
                                                <tr>
                                                    <td class="font-weight-bold pt-2 text-center">
                                                        ...
                                                        SLUŽIEB SÚVISIACICH S PREDAJOM A KÚPOU NEHNUTEĽNOSTÍ – DOM - POZEMOK
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <br><br>
                                                        ALL INCLUSIVE REAL, s.r.o., so sídlom Ul. Biskupa Kondého 5138/30, 929 01 Dunajská Streda, IČO: 54140099, DIČ: 2121574059 zapísaná v obchodnom registri Okresného súdu v Trnave, v oddieli  Sro, zastúpená na základe generálnej plnej moci Viktor Hodosi
                                            ...
                                            <table class="custom-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <br>
                                                        <br>
                                                        (ďalej  len ako „Záujemcovia“ tým sa má na mysli aj budúci kupujúci na druhej  strane )
                                                        <br>
                                ...
                                Predmet predaja a kúpy - Nehnuteľnosti:</span>
                                            ...
                                            <br>
                                            <br>
                                            <div class="text-center"><span>V Dunajskej Strede, dňa  <input name="text[]" type="text"></span></div>
                                            <br>
                                            <br>
                                            <div class="row">
